...
--
-- Table structure for table `helpercv`
--

DROP TABLE IF EXISTS `helpercv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `helpercv` (
  `helpermemberid` int NOT NULL,
  `account` varchar(255) DEFAULT NULL,
  `helpercvlink` varchar(512) DEFAULT NULL,
  `helperphoto` varchar(512) DEFAULT NULL,
...
--
-- Dumping data for table `helpercv`
--
