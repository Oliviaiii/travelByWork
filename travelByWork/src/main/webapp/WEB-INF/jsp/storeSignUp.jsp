			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1><a href="storeSignUp">店家註冊</a></h1>
						<nav id="nav">
							<ul>
								<li class="special">
								...
								<section>
									...
									<form method="post" action="#">
										<div class="row gtr-uniform">
											...
											<div class="col-6 col-12-xsmall">
												<input type="text" name="storename" id="storename" value="" placeholder="店家名稱" />
											</div>
											<div class="col-6 col-12-xsmall">
												<input type="text" name="ownername" id="ownername" value="" placeholder="負責人姓名" />
											</div>
											<div class="col-6 col-12-xsmall">
												<input type="text" name="mobile" id="mobile" value="" placeholder="電話" />
											</div>
											<div class="col-6 col-12-xsmall">
												<input type="text" name="email" id="email" value="" placeholder="電子郵件（Gmail）" />
											</div>
									
									
									<ul class="actions">
										<li><a href="emailSuccess" class="button large">註冊（跳轉註冊成功驗證mail）</a></li>
									</ul>
